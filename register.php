...
<head>
    ...
    <title> Registro | Soluciones Tech & Game </title>
    ...
    <form class="form-default" action="login-bg.mp4" method="POST">
        ...
        <div class="login-form">
            ...
            <div class="logo-login">
                <a href="index.php"><img src="assets/img/logo/ico.png" alt=""></a>
            </div>
            ...
            <div class="form-input">
                ...
                <input type="email" name="email" placeholder="Escriba su cuenta de correo">
            </div>
            <div class="form-input">
            ...
            <div class="form-input">
                <label for="name">Confirmar Contrase&ntilde;a</label>
                <input type="password" name="password" placeholder="">
            </div>
            ...
            <!-- Forget Password -->
            <a href="login.html" class="registration">Iniciar Sesi&oacute;n</a>
        </div>
    </form>
    <!-- /end login form -->
</main>
